            ...
            <div class="h-full w-full p-4 xl:p-6">
                <div class="flex flex-col h-full">
                    <div class="flex flex-row text-fullbright text-xl md:text-3xl text-left items-center font-extrabold whitespace-pre-line">
                        <div class="text-[28px] md:text-[36px] xl:text-[48px] mr-4 md:mr-6 text-prime">
                            {props.icon || <div></div>}
                        </div>
                        {props.title}
                    </div>
                    <div class="mt-4 text-prime">
                        ...
                        <div class="flex flex-row text-fullbright text-md xl:text-xl md:border-l border-prime md:px-4 md:mx-4 md:my-1">
                            {props.text}
                        </div>
